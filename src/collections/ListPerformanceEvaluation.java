...
/*Teste pra verificação das performances das operações do ArrayList X LinkedList
	Conclusões:
		ArrayList -> Geralmente mais rápido para adicionar elementos no final
					Remover elementos do final não é tão eficiente quando o linkedList, mas não é tão distante.
					Mais rápido para adicionar ou remover elementos do meio do vetor.

		LinkedList -> Muito mais rápido para adicionar e remover do início do vetor.
						Muito mais rápido para remover ao final, mas fica um pouco atrás de arrayList para adicionar.
						Extremamente lento para adicionar e remover do meio do vetor.
